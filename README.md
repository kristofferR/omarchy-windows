...
In Floating Mode, use the native titlebar to drag a window. Its controls remain visible at all times; the square button toggles maximization and the close button closes the window.
